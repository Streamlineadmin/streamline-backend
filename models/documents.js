...
module.exports = (sequelize, DataTypes) => {
  ...
  Documents.init({
    ...
    isMultiCurrency: DataTypes.BOOLEAN,
    exchangeRate: DataTypes.FLOAT,
    currencyCode: DataTypes.STRING,
    portOfLoading: DataTypes.STRING,
    portOfDischarge: DataTypes.STRING,
    countryOfOrigin: DataTypes.STRING,
    countryOfDischarge: DataTypes.STRING,
    finalDestination: DataTypes.STRING,
    countryOfFinalDestination: DataTypes.STRING,
    lcNumber: DataTypes.STRING,
    lcIssueBank: DataTypes.STRING,
    lutNumber: DataTypes.STRING,
    lutValidTill: DataTypes.STRING,
